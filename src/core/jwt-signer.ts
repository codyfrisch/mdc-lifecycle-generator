  ...
  const jwtDat: LifecycleJwtDat = {
    ...
    subscription: payload.data.subscription
      ? {
          ...
          renewal_date: payload.data.subscription.renewal_date ?? null,
          is_trial: payload.data.subscription.is_trial,
          billing_period: payload.data.subscription.billing_period ?? null,
          days_left: payload.data.subscription.days_left ?? null,
